...
public enum ErrorStatus {
    ...
    HAVE_AVAILABLE_SPRINKLE(HttpStatus.BAD_REQUEST, 2001, "이미 뿌리기를 진행하고 있습니다."),
    ...
    HEAVY_LOAD_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, 8001, "시스템 고부하 영향으로 처리되지 못했습니다. 다시 시도해 주세요."),
